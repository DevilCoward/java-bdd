...
public class WDAServer {
    ...
    private static final Timedelta REAL_DEVICE_RUNNING_TIMEOUT = Timedelta.fromMinutes(4);
    private static final Timedelta RESTART_TIMEOUT = Timedelta.fromMinutes(1);
    ...
    private static final File IPROXY_EXECUTABLE =
    ...
    private static final File XCODEBUILD_LOG =
            new File(
                    String.format(
                            "%s/mobile/WebDriverAgent/build.log", System.getProperty("user.home")));
    private static final File IPROXY_LOG =
            new File(
                    String.format(
    ...
    private static final String[] IPROXY_CMDLINE =
            new String[] {
    ...
    public static synchronized WDAServer getInstance() {
        if (instance == null) {
    ...
    public static List<String> retrieveProvisioningProfile() {
    ...
    private static final String DEVICES_SECTION_START =
            SECTION_MARKER + " Devices " + SECTION_MARKER;
    ...
    private static Optional<String> parseSimulatorId(
